...
## Planning Meetings (sprintNbacklog.csv, sprintN.md) (max 3 marks)
  ...
  - Sprint N Backlog (sprintNBacklog.csv) (max 1 mark)
    ...
    Your Mark: 0.5 Sprint 1 backlog should contain the sprint 1 user stories not all from product backlog
...
Design Patterns Total Mark: 12 / 12 (Project_proposal should be renamed as designPatterns)
