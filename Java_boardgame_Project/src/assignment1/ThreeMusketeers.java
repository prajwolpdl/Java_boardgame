...
public class ThreeMusketeers {
    ...
    private Boolean suggestMovesOn;
    ...
    public void turnOnSuggestedMoves() {
        this.suggestMovesOn = true;
    }
	
    public void turnOffSuggestedMoves() {
    	this.suggestMovesOn = false;
    }
    
    public boolean isSuggestedMovesOn() {
    	return this.suggestMovesOn;
    }
    ...
    private void undoMove() {
    	if (!this.moves.isEmpty()) {
	    	Move remove = moves.remove(moves.size()-1);
	   	this.board.undoMove(remove);
    	}
    }
