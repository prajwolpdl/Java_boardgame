...
## Planning Meetings (sprintNbacklog.csv, sprintN.md) (max 3 marks)
  ...
  - Sprint N Backlog (sprintNBacklog.csv) (max 1 mark)
    ...
    Your Mark: 0.5 (Some user stories matching in backlog does not match with sprint2 md file. e.g 2.1,2.2 not included in the backlog)

  Planning Meetings Total Mark: 2.5 / 3
...
## Featurework  (max 18 marks) 
  ...
  - Do the pull request on GitHub match the stories/tasks listed in the sprint backlog? (max 2 marks)
    ...
    Your Mark: 1.5 (1.4 in the code review does not match with any pull request)
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1 Few messages missing ticket number
...
Featurework Total Mark: 16.5 / 18
